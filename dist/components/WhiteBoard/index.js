...
var Whiteboard = function Whiteboard(_ref9) {
  ...
  var loadCanvasPage = (0, _react.useCallback)(function (canvas, pageIndex) {
    clearCanvas(canvas);
    backUpCanvas = [];

    try {
      var _json$historyIndex3, _json$historyIndex3$o;

      if (canvasPage[pageIndex] !== undefined) {
        var _json$historyIndex2;

        canvas.loadFromJSON(canvasPage[pageIndex], canvas.renderAll.bind(canvas));

        if ((_json$historyIndex2 = json[historyIndex]) != null && _json$historyIndex2.screen) {
          canvas.setZoom(canvasOriginalWidth / json[historyIndex].screen);
        }
      } else if ((_json$historyIndex3 = json[historyIndex]) != null && (_json$historyIndex3$o = _json$historyIndex3.object) != null && _json$historyIndex3$o[pageIndex]) {
        canvas.loadFromJSON(json[historyIndex].object[pageIndex], canvas.renderAll.bind(canvas), function (o, object) {
          var _json$historyIndex4;

          object.set('selectable', false);
          object.set('evented', false);

          if ((_json$historyIndex4 = json[historyIndex]) != null && _json$historyIndex4.screen) {
            canvas.setZoom(canvasOriginalWidth / json[historyIndex].screen);
          }
        });
      }
  ...
  function onSaveCanvasAsImage(resendText, canvas) {
    if (json.length === 0 && index + 1 === fileCanvasInfo.totalPages && !pdfViewer || json.length !== 0 && index + 1 === totalPages && !pdfViewer) {
      ...
      (0, _sweetalert.default)({
        ...
        var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(willDelete) {
